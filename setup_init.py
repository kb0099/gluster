...
prep_test = "mkdir -p /var/log; cd /var/log; touch messages; echo '%s' > messages" %  test_value
do_test = "for i in {0..100}; do cp -rp /var/log/messages /mnt/copy-test-\$i; done"
...
os.system('docker exec -ti g1 bash -c "%s"' % "ls -lA /mnt/copy* | wc -l")
os.system('docker exec -ti g2 bash -c "%s"' % "ls -lA /bricks/brick0/gv0/copy* | wc -l")
os.system('docker exec -ti g3 bash -c "%s"' % "ls -lA /bricks/brick0/gv0/copy* | wc -l")
